<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-400 dark:text-gray-400 leading-tight">
            {{ __('Lista de alunos cadastrados no sistema:') }}
        </h2>
    </x-slot>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700">
                                        @if(Auth::user()->role === 'teacher')
                                            <a href="#" class="border border-green-600 rounded-lg inline-flex items-center px-4 py-2 text-white bg-green-600 hover:bg-green-700 ml-2">
                                                Editar
                                            </a>
